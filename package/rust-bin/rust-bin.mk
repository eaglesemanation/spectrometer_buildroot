...
RUST_BIN_SITE = https://static.rust-lang.org/dist/2023-06-07
...
HOST_RUST_BIN_EXTRA_DOWNLOADS += rust-std-$(RUST_BIN_VERSION)-$(RUSTC_WASM_TARGET_NAME).tar.xz
endif
...
ifeq ($(BR2_PACKAGE_HOST_RUSTC_WASM_SUPPORT), y)
define HOST_RUST_BIN_INSTALL_LIBSTD_WASM
	(cd $(@D)/std/rust-std-$(RUST_BIN_VERSION)-$(RUSTC_WASM_TARGET_NAME); \
		./install.sh $(HOST_RUST_BIN_INSTALL_COMMON_OPTS))
endef
endif
...
define HOST_RUST_BIN_INSTALL_CMDS
	...
	$(HOST_RUST_BIN_INSTALL_LIBSTD_WASM)
endef
